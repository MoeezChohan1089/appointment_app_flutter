...
class _RegisterPageState extends State<RegisterPage> {
  ...
  _getLocation() async {
    try {
      ...
      var addresses = await geoCode.forwardGeocoding(address: "$latitude.$longitutde");
      print("Print Address: $addresses");
      await FirebaseFirestore.instance.doc('location').set({
