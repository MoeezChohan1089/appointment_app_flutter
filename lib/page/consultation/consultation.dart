...
class _ConsultationPageState extends State<ConsultationPage> {
                  ...
                  child: Column(
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage: queue
                                    .transactionData!.createdBy!.profileUrl !=
                                ""
                            ? NetworkImage(
  ...
  _startConsulting() async {
    bool konfirmasi = await showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text("Are you sure want to start?"),
        content: Text(
  ...
  _finish(BuildContext context) async {
    bool konfirmasi = await showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text("Are you sure want to finish this consultation?"),
        content: Text(
    ...
    if (konfirmasi) {
      ...
      String? diagnosis = await showDialog(
        context: context,
        builder: (context) => AlertDialog(
          title: Text("Diagnosis Patient"),
          content: TextField(
            controller: _txtDiagnosis,
            decoration: InputDecoration(hintText: "Diagnosis Patient"),
          ),
          actions: [
            ElevatedButton(
